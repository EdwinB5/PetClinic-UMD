...
<div class="well well-sm text-right">
    <a class="btn btn-danger" href="?c=Mascota&a=Crud">Nueva mascota</a>
</div>
...
<table class="table table-striped">
    ...
    <?php foreach($this->model->Listar() as $r): ?>
        <tr>
            ...
            <td>
                <a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="?c=Mascota&a=Eliminar&id_mascota=<?php echo $r->id_mascota; ?>">Eliminar</a>
            </td>
        </tr>
    <?php endforeach; ?>
    </tbody>
